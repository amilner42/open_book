defmodule OpenBookWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OpenBookWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OpenBookWeb.Gettext, "errors", msg, opts)
    end
  end
