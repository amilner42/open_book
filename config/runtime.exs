...
if config_env() == :prod ||
     (config_env() == :dev && System.get_env("USE_LOGFLARE_IN_DEV") == "yes") do
  config :logger,
    level: :info,
...
#
#     PHX_SERVER=true bin/open_book start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :open_book, OpenBookWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :open_book, OpenBook.Mailer,
